...
def partition_input_space_with_codebook(
    ...
    Args:
        ...
        gcb_idx: if the component is a group codebook, the index of the codebook. Otherise, None.
...
def patch_in_codes_var_pos(run_cb_ids, hook, pos, code):
...
def clean_patching_name(patching):
    """Clean the patching name "l0,l1_attn" -> "L0, L1 Attn"."""
    if patching == "none":
        return "None"
    layers = patching.split("_")[0].split(",")
